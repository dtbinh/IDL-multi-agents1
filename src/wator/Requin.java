...
public class Requin extends Agent {
   ...
   *
   * @return <code>true</code> si le requin doit mourir, <code>false</code>
   *         sinon.
   */
   ...
   *
   * @return <code>true</code> si le requin peut se reproduire,
  ...
  /**
   * Faire se reproduire un Requin.
   * 
   * @param x
   *          coordonnée horizontale du nouveau Requin
   * @param y
   *          coordonnée verticale du nouveau Requin
  ...
  /**
   * Verifie si le requin peut manger un poisson aux alentours. Si c'est le cas,
   * on retourne les coordonnees du poisson à manger.
   *
  ...
  private Coordonnees peutManger() {
	...
	// On va parcourir toutes les directions en partant d'une direction au
	// hasard
  ...
  /**
   * Verifie s'il y a une place libre aux alentours. Si c'est le cas, on
   * retourne les coordonees de la place libre.
   *
